...
Source: "https://npcap.com/dist/npcap-1.84.exe"; DestDir: "{app}"; DestName: "npcap.exe"; ExternalSize: "10485760"; Flags: ignoreversion external download
...
[Run]
Filename: "{app}\{#NpCapExeName}"; Description: "{cm:LaunchProgram,{#StringChange(NpCapExeName, '&', '&&')}}";
