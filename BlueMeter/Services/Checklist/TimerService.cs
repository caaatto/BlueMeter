...
///
/// Direct port of the WPF version. The only material change is
/// <see cref="System.Windows.Threading.DispatcherTimer"/> →
/// <see cref="Avalonia.Threading.DispatcherTimer"/> — Avalonia's DispatcherTimer is
/// a drop-in replacement with no constructor argument, and ticks on the UI thread
