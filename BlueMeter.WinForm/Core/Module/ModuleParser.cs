...
using static BlueMeter.WinForm.Core.Module.ModuleCardDisplay;
using static BlueMeter.WinForm.Core.Module.ModuleOptimizer;
using static BlueMeter.WinForm.Forms.ModuleForm.ModuleCalculationForm;
